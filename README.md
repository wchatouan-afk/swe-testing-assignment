# Quick-Calc
Application de calculatrice simple pour le cours de Advanced Software Engineering.

## Installation
1. Avoir Python installé.
2. Télécharger les fichiers `calculator.py` et `test_calculator.py`.

## Exécuter les tests
Lancez la commande suivante dans votre terminal :
`python3 -m unittest test_calculator.py`

## Recherche : Frameworks de Test
